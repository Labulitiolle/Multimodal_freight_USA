    ...
    nodes = gpd.GeoDataFrame(
        {
            ...
            "trans_mode": {1000000000: 'raod', 1000000001: 'raod', 1000000002: 'raod'},
...
def gen_graph_for_price():
    ...
    return build_graph.graph_from_gdfs2(nodes, edges)


@pytest.fixture()
def gen_graph_for_details():
    nodes = gpd.GeoDataFrame(
        index=[10000, 10002, 10003, 10004, 10005],
        data={
            "trans_mode": ["road", "intermodal", "rail", "rail", "intermodal"],
            "x": [-22, 2, 2, 1, 2],
            "y": [-30.1, 3, 3, 1, 1],
            "osmid": [10000, 10002, 10003, 10004, 10005],
            "geometry": [Point(-22, -30.1), Point(2, 3), Point(1, 1), Point(2, 1), Point(2, 1)],
            "STCYFIPS": [12343, 12345, 12123, 12124, 12122],
        },
    )

    edges = gpd.GeoDataFrame(
        {
            "trans_mode": {0: "intermodal_link", 1: "rail", 2: "rail", 3: "intermodal_link"},
            "dist_miles": {0: 1000, 1: 1000, 2: 1000, 3: 2000},
            "u": {0: 10000, 1: 10002, 2: 10003, 3: 10004},
            "v": {0: 10002, 1: 10003, 2: 10004, 3: 10005},
        }
    )
